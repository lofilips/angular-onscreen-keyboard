...
export declare class MatKeyboardComponent implements OnInit {
     ...
     * @param targetState
     */
    onCapsClick(event: any, targetState?: boolean): void;
    onKeyClick(event: any): void;
    /**
     ...
     */
    onShiftClick(event: any): void;
    onBkspClick(event: any): void;
